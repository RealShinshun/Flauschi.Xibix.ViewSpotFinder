...
Execute unit tests
```
    cd "Flauschi.Xibix.ViewSpotFinder.AwsServerlessApplication/test/Flauschi.Xibix.ViewSpotFinder.AwsServerlessApplication.Tests"
    dotnet test
```

Deploy application
```
    cd "Flauschi.Xibix.ViewSpotFinder.AwsServerlessApplication/src/Flauschi.Xibix.ViewSpotFinder.AwsServerlessApplication"
